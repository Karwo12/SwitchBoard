...
public sealed class ActionDescriptor
{
    ...
    public ActionDescriptor(
        ...
        ActionAdministratorRequirement administratorRequirement = ActionAdministratorRequirement.None)
    {
        TypeId = typeId;
        ...
        AdministratorRequirement = administratorRequirement;
    }
    ...
    public ActionAdministratorRequirement AdministratorRequirement { get; }
...
/// <summary>
/// Non-visual capability metadata used by profile preflight. It deliberately
/// lives beside action type metadata rather than being inferred from UI text.
/// </summary>
public enum ActionAdministratorRequirement
{
    None,
    WhenRequested,
    MayRequire
...
public static class ActionDescriptorRegistry
{
    ...
    [
        new(ActionTypeIds.ProgramRun, "Action.RunProgram", "ActionPicker.Category.Programs",
            ["program", "programy"], nested => nested
                ...
                : new JsonObject
                {
                    ...
                    [ActionParameterNames.ProcessStartWaitSeconds] = 10,
                    [ActionParameterNames.ProcessTargetMode] = ProcessTargetModeIds.Automatic
                }, administratorRequirement: ActionAdministratorRequirement.WhenRequested),
        new(ActionTypeIds.ServiceSetState, "Action.WindowsServiceState", "ActionPicker.Category.SystemDevices",
            ...
            }, administratorRequirement: ActionAdministratorRequirement.MayRequire),
        ...
        new(ActionTypeIds.PowerSetPlan, "Action.PowerPlan", "ActionPicker.Category.SystemDevices",
            ["power", "zasilanie"], administratorRequirement: ActionAdministratorRequirement.MayRequire),
        ...
        new(ActionTypeIds.Comment, "Action.Comment", "ActionPicker.Category.Automation",
            ["comment", "komentarz", "note", "notatka"], _ => new JsonObject
            {
                [ActionParameterNames.CommentText] = string.Empty
            }),
